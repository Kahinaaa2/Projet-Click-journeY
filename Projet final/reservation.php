...
<?php echo '<img src="image/' . trim($lignes[2]) . '_2.1.1.jpg">';?>
<div class="container">
...
<form action="recap.php" method="GET" class="formulaire">
...
document.getElementById('option-container').innerHTML = '';
  ...
  for (let i = 0; i < nbAdultes; i++) {
	...
	<div class="int-option1">
		...
		<p>Billets d'Avion (inclus) : <?php echo $prix; ?>€</p>
		...
		<div class="int-option3">			
	      <label><input type="checkbox" onchange="calculerTotal()" name="options[${i}][hebergement]"value="hebergement"><p>Hébergement</p></label>
              <label><input type="checkbox" onchange="calculerTotal()" name="options[${i}][restaurant]" value="restaurant"><p>Restaurants</p></label>
              <label><input type="checkbox" onchange="calculerTotal()" name="options[${i}][extra]" value="extra"><p>Sortie&nbsp;<span>Extra</span></p></label>
...
document.getElementById('option-container2').innerHTML = '';
  ...
  for (let i = 0; i < nbEnfants; i++) {
	...
	<div class="int-option1">
		...
		<p>Billets d'Avion (inclus) : <?php echo $prix2; ?>€</p>
